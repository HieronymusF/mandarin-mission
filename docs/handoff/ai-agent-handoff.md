...
- 生产路由已有 Journey/Review/Settings 主导航，课程保持独立；帮助、隐私、条款状态页、本地数据清理和版本信息首切片已实现，但无引导、真实客服/法律资源、个人/账号或完整设置；
- 客户端没有远端认证、同步或商店支付接线；
...
1. 继续完成 App 信任外壳：首切片已交付主导航、设置、帮助/隐私/条款状态、数据管理、版本信息和主要页面状态；下一步补首次引导、其余设置、真实客服/法律资源与真机验收；
