...
- 当前阶段：一期工程基础已建立；包含纯 Dart 学习核心、课程 Schema/Fixture、Go API 容器、Flutter Android/iOS App 外壳、Drift v1 本地 schema、安装包内课程 Repository，以及由内容数据驱动的七步“点咖啡”课程播放器和移动端 CI。
- 当前下一里程碑：完成“点咖啡”一节课的 Android 端到端垂直切片。
- 当前下一小模块：持久化课程练习结果和四维掌握状态，使课程完成后的本地进度可供复习队列使用。
